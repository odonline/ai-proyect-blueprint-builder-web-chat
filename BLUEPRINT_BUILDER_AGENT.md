...
6. Generate the corresponding document using the `generate_file` tool.
7. IMMEDIATELY call the `complete_stage` tool to advance the system state.
8. DO NOT discuss the next stage until the current one is officially closed via tool.
